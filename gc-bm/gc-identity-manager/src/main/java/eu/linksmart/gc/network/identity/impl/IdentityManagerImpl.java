...
public class IdentityManagerImpl implements IdentityManager, MessageProcessor {
	...
	public void deactivate() {
		...
		this.scClient = null;
		LOG.info("[stopping identity manager]");
	}
	...
	private void startThreads() {
		...
		LOG.info("identity manager broadcast and update threads have been started");
	}
	...
	private void stopThreads() {
		...
		LOG.info("identity manager broadcast and update threads have been stopped");
	}
