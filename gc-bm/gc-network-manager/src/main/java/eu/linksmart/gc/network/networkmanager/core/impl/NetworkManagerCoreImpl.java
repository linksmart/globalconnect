...
public class NetworkManagerCoreImpl implements NetworkManagerCore, MessageDistributor {
	...
	public void initialize() {
		LOG.info("initializing network manager core");
		init();
	}
	...
	/**
	 * Initializes the component, i.e. creates own VirtualAddress
	 * 
	 * @param context
	 */
	private void init() {
		...
		// BackboneSOAPImpl.
		try {
			this.myVirtualAddress = registerService(attributes, endpoint, nmBackbone).getVirtualAddress();
