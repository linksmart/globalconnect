package eu.linksmart.gc.network.backbone.protocol.fixme;
...
@Component(name="BackboneFixMe", immediate=true)
@Service({Backbone.class})
public class FixMeBackboneProtocolImpl implements Backbone {
    private Logger LOG = Logger
            .getLogger(FixMeBackboneProtocolImpl.class.getName());
    ...
    protected void activate(ComponentContext context) throws Exception {
        LOG.info("[activating Backbone FixmeProtocol]");
    ...
    public void deactivate(ComponentContext context) {
        ...
        LOG.info("[de-activating Backbone FixMeProtocol]");
    ...
    public String getName() {
        return FixMeBackboneProtocolImpl.class.getName();
    }
